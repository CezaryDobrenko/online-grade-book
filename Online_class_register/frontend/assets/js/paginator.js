...
function paginator(config) {
    ...
    if (typeof config.box_mode == "function") {
		...
		page_box.className += "col-4 col-12-medium"; 
        if (config.box_mode == "list") {
		...
		var li1 = make_button(1, 1, config, false, (page == 1));
        page_box.appendChild(li1);
		var li2 = make_button(pages, pages, config, false, (page == pages));
        page_box.appendChild(li2);
    ...
    if (!(typeof config.page_options == "boolean" && !config.page_options)) {
		...
		template.className += "col-4 col-12-medium"; 
	...
	stat.className += "col-4 col-12-medium"; 
